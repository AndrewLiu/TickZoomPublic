...
{
    public static class WilderRSIFormulaExtension
    {
        public static WilderRSI WilderRSI(Formula formula, object obj, int period)
        {
            WilderRSI wilderRSI = new WilderRSI(obj, period);
            formula.Model.AddDependency(wilderRSI);
            return wilderRSI;
        }
    }
