...
namespace TickZoom.Api
{
    ...
    public interface Log 
    {
		...
		void VerboseFormat(LogMessage format, params object[] args);
        void TraceFormat(LogMessage format, params object[] args);
        void DebugFormat(LogMessage format, params object[] args);
