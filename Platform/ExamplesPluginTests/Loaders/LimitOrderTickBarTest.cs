...
namespace Loaders
{
	...
	public class LimitOrderTickBarTest : StrategyBaseTest
	{
		...
		public void VerifyCurrentEquity() {
			Assert.AreEqual( 8800,Math.Round(strategy.Performance.Equity.CurrentEquity,2),"current equity");
		}
		[Test]
		...
		public void VerifyClosedEquity() {
			Assert.AreEqual( 6100,Math.Round(strategy.Performance.Equity.ClosedEquity,2),"closed equity");
		}
		[Test]
